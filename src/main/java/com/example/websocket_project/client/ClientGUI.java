...
public class ClientGUI extends JFrame implements MessageListener{
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(ClientGUI.this,
                        "Do your really waant to leave?", "Exit", JOptionPane.YES_NO_OPTION);
    ...
    private void addChatComponents(){
        ...
        messagePanelScrollPane.setBackground(Utilities.SECONDARY_COLOR);
...
//        messagePanel.add(createChatMessageComponent(new Message("Jessica Ferrgani", "Some text to check the message box")));
    ...
    public void onActiveUsersUpdated(ArrayList<String> users) {
        ...
        // the user list panel doesn't get added until after and this is mainly for when the user get updated
